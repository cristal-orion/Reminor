...
func (m *CursorModel) SetMode(mode Mode) tea.Cmd {
	...
	if mode == CursorBlink {
		return func() tea.Msg { return CursorBlinkCmd() }
	}
	return nil
}
...
// CursorBlinkCmd is a command used to initialize cursor blinking.
func CursorBlinkCmd() tea.Msg {
	return initialBlinkMsg{}
}

// Focus focuses the cursor to allow it to blink if desired.
func (m *CursorModel) Focus() tea.Cmd {
	m.focus = true
